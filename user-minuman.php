...
<body>
  ...
  <!-- makanan -->
  <section id="user-minuman.php">
    <div id="wrapper">
        <div class="kotak">
            <h1 style="font-family: 'Jost', sans-serif; color: white; font-size: 27px; margin-left: 10px;">
                Minuman
            </h1>
            <form action="user-minuman.php" method="get">
                <div class="search-container">
                    <input class="search-input" type="search" id="searchInput" name="search" placeholder="Cari Minuman...">
