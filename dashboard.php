...
<body>
    ...
    <div class="d-flex flex-column">
      ...
      <nav id="navbar" class="nav-menu navbar">
        <ul>
          ...
          <li><a  href="javascript:void(0);"  id="logout-link" class="nav-link scrollto"><i class='bx bx-log-out' ></i> <span>Keluar</span></a></li>
        </ul>
      </nav><!-- .nav-menu -->
    </div>
  </header><!-- End Header -->
  ...
  <script src="assets/js/konfirmasi-logout.js"></script>
